...
ts_specific_features_trg <- "~/cleartrail_osn/SET3/TC1/ts_specific_features_23_Feb_2016_Set_I.csv"
...
ts_specific_features_test <- "~/cleartrail_osn/SET3/TC2/ts_specific_features_23_Feb_2016_Set_II.csv"
